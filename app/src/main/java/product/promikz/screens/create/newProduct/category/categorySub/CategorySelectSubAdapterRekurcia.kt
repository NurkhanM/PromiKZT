...
class CategorySelectSubAdapterRekurcia(private val onClickListener: IClickListnearSubscriberCategory) :
    RecyclerView.Adapter<CategorySelectSubAdapterRekurcia.MyViewHolder>() {
