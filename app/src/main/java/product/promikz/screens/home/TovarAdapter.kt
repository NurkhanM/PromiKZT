...
import product.promikz.models.similar.Data
...
class TovarAdapter(private val mIClickListnear: IClickListnearHomeFavorite) :
    RecyclerView.Adapter<TovarAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        MyUtils.uGlide(context, holder.binding.itemHomeImages, currentItem.img)
        ...
        holder.binding.itemFavorite.setOnClickListener {
            mIClickListnear.clickListener(currentItem.id, holder.binding, currentItem.isLike, position)
            currentItem.isLike = !currentItem.isLike
            notifyItemChanged(position)
        }

        holder.binding.rowCostom.setOnClickListener {
            mIClickListnear.clickListener2(currentItem.id,
                currentItem.type,
