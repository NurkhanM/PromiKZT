...
class ProfileDeActiveAdapter(private val mIClickListnear: IClickListnearProfille) :
    RecyclerView.Adapter<ProfileDeActiveAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.binding.itemProfileDeactive.visibility = View.GONE
        ...
        holder.binding.itemProfileActive.setOnClickListener {
