...
import product.promikz.databinding.FragmentComplaintUserBinding
import product.promikz.viewModels.HomeViewModel

class ComplaintUserFragment : Fragment() {

    private var _binding: FragmentComplaintUserBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentComplaintUserBinding.inflate(inflater, container, false)
        val view = binding
...
//                alertDialogMessage("Успех", "Ваша жалоба было успешно принято")
                Toast.makeText(
                    requireContext(),
                    "Ваша жалоба было успешно принято",
                    Toast.LENGTH_SHORT
                ).show()
                val intent = Intent()
