...
import product.promikz.databinding.FragmentComplaintSpecialistBinding
import product.promikz.viewModels.HomeViewModel

class ComplaintSpecialistFragment : Fragment() {

    private var _binding: FragmentComplaintSpecialistBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentComplaintSpecialistBinding.inflate(inflater, container, false)
        val view = binding

        dialog = Dialog(requireContext())
        val arguments = (activity as AppCompatActivity).intent.extras
        idSpec = arguments!!["specID"] as Int
        ...
        view.btnSend.setOnClickListener {
            ...
            viewModels.postReport("Bearer $TOKEN_USER",
                idSpec,"specialist", "$nameRadio ${view.editComplaint.text.toString().trim()}", viewRep)
        }
